      ...
      <div className="mx-auto max-w-7xl">
        <section className="relative mb-8 overflow-hidden rounded-[3rem] border border-cyan-400/50 bg-[#070b1f] p-10 shadow-2xl shadow-purple-950/50">
          ...
          <div className="absolute right-0 top-0 h-full w-2/3 opacity-70">
            <div className="absolute right-16 top-20 h-40 w-130 rotate-[-8deg] rounded-full border border-purple-500/40 blur-[2px]" />
            <div className="absolute right-12 top-28 h-36 w-130 rotate-[8deg] rounded-full border border-cyan-500/30 blur-[2px]" />
            <div className="absolute right-28 top-36 h-28 w-115 rotate-15 rounded-full border border-purple-500/25 blur-[2px]" />
          </div>
          ...
          <div className="relative flex flex-col justify-between gap-8 md:flex-row md:items-start">
            <div>
              <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-purple-400/40 bg-purple-500/25 px-5 py-3 text-sm font-bold text-purple-100 shadow-lg shadow-purple-950/40">
          ...
          <Button
            asChild
            className="h-16 rounded-2rem bg-linear-to-r from-purple-600 to-cyan-400 px-10 text-lg font-bold text-white shadow-xl shadow-cyan-950/50 hover:scale-105 hover:opacity-95"
          >
            <Link to="/add">
          ...
          <div className="grid gap-4 md:grid-cols-[1fr_280px]">
            <div className="relative">
              ...
              <Input
                ...
                className="h-14 rounded-1.5rem border-slate-600 bg-slate-950/60 pl-14 text-base text-white placeholder:text-slate-400"
              />
            </div>
            ...
            <div className="relative">
              ...
              <select
                ...
                className="h-14 w-full rounded-1.5rem border border-slate-600 bg-slate-950/60 pl-14 pr-4 text-base font-semibold text-white outline-none"
              >
...
function StatCard({
  ...
  return (
    <div
      className={`rounded-2rem border bg-slate-900/60 p-7 shadow-xl backdrop-blur-xl ${colors[color]}`}
    >
