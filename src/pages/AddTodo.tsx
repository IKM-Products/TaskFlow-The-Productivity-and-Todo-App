...
import { ArrowLeft, CalendarDays, Clock3, Flag, Plus, Sparkles } from "lucide-react";
    ...
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,#10153d,#050816_45%,#020617_100%)] px-4 py-10 text-white">
      <div className="mx-auto max-w-4xl">
        ...
        >
          ...
          <Button
            type="submit"
            className="h-14 w-full rounded-2xl bg-linear-to-r from-purple-600 to-cyan-400 text-lg font-bold text-white shadow-xl shadow-cyan-950/50 hover:scale-[1.01] hover:opacity-95"
          >
